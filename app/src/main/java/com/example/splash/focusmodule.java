...
public class focusmodule extends AppCompatActivity {
    int hours,minute;
    Button btnStart;
    Button btnSet;
    EditText edtset;
    ...
    protected void onCreate(@Nullable  Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_focusmodule);
        ...
        btnSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.length()==0){
                    Toast.makeText(focusmodule.this, "Field Can't be empty", Toast.LENGTH_SHORT).show();
                }
                long millisInput = Long.parseLong(input) * 60000;
                if (millisInput == 0) {
                    Toast.makeText(focusmodule.this, "Please enter a positive number", Toast.LENGTH_SHORT).show();
                    return;
                }
                setTime(millisInput);
                edtset.setText("");
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(focusmodule.this, "You Can Access The App", Toast.LENGTH_SHORT).show();
    ...
    public void OpenApplock(View view){
        Intent intent= new Intent(focusmodule.this, MainActivity.class);
