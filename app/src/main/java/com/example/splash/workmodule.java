...
public class workmodule extends AppCompatActivity {
    int hours;
    int minute;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.length()==0){
                    Toast.makeText(workmodule.this, "Field Can't be empty", Toast.LENGTH_SHORT).show();
                }
                long millisInput = Long.parseLong(input) * 60000;
                if (millisInput == 0) {
                    Toast.makeText(workmodule.this, "Please enter a positive number", Toast.LENGTH_SHORT).show();
                    return;
                }
                setTime(millisInput);
                edtset.setText("");
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(workmodule.this, "You Can Access The App", Toast.LENGTH_SHORT).show();
    ...
    public void OpenApplock(View view){
        Intent intent= new Intent(workmodule.this, MainActivity.class);
